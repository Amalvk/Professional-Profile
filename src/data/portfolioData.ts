...
export const liveProjects: Project[] = [
  ...
  {
    name: "Chittymate",
    image: "/screenshots/chittymate.png",
    ...
    roles: [
      "Real-time auction experience with countdown-based lot selection, automated winner exclusion, and animated winner reveal",
      "Cycle management with automated transitions and historical tracking of previous chitti holders",
      "Shared read-only view for chitti status, payment progress, upcoming auctions, and winner history across mobile and desktop",
    ],
