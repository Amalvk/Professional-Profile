...
export const profile = {
  ...
  tagline:
    "Frontend developer with significant professional experience in the React ecosystem, delivering high-quality, production-ready code across enterprise SaaS products.",
